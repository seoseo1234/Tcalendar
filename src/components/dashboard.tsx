...
export default function Dashboard() {
  ...
  return <div className="app-shell">
    ...
    <main>
      <header className="topbar"><button className="menu-button" onClick={() => setSidebar(true)} aria-label="메뉴 열기"><Menu /></button><button className="mobile-logo" onClick={openCalendar} aria-label="캘린더 홈으로 이동"><Logo compact /></button>
